<script lang="ts">
	...
	const apps = [
		...
		{ name: 'Poze', icon: 'photos', color: 'from-pink-400 via-yellow-400 to-blue-400' },
		...
		<div class="w-[375px] h-[812px] rounded-[45px] overflow-hidden relative" style="background: linear-gradient(180deg, #1c1c1e 0%, #000000 100%);">
			...
			<div class="relative z-10 px-6 pt-16">
				<div class="grid grid-cols-4 gap-5">
					{#each apps as app}
						<button class="flex flex-col items-center gap-1.5 transition-transform hover:scale-110 active:scale-95" on:click={() => openApp(app.name)}>
			...
			<div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
				<div class="flex items-center gap-4 px-5 py-3 bg-white/10 backdrop-blur-xl rounded-[28px] border border-white/10">
					{#each dockApps as app}
						<button class="relative transition-transform hover:scale-110 active:scale-95" on:click={() => openApp(app.name)}>
